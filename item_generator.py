...
Item5 = Item(name="Gateron Blues (70 Pack)", category=3, price=20, description="Gateron switches are one of the most sought after products in the mechanical keyboard community. Gateron switches provide a clear transparent housing with 50 million cycles. The inside is finished with copper click leaf and soft plastic stem to provide a smooth typing experience. These switches are made with the same stem as Cherry so all our keycaps are compatible with this DIY product.",
             ...
             created_by=2)
session.add(Item5)
Item6 = Item(name="Zealio (70 Pack)", category=3, price=59.99, description="65g Zealios - Smooth, long, drawn out tactile bump in the middle. Nice cushion during bottom out.",
             image="https://cdn.shopify.com/s/files/1/0490/7329/products/zealios2.jpeg?v=1453017871",
             created_by=2)
session.add(Item6)
Item7 = Item(name="Keycap Puller", category=4, price=6.99, description="The perfect tool to set up your keyboard with all your new custom keys.  The wire puller design makes it simple to quickly and safely remove a cap from almost any kind of keyboard on the market.",
             image="http://cdn.shopify.com/s/files/1/0218/4886/products/KeyPuller2_1024x1024.jpg?v=1429499476",
             created_by=1)
session.add(Item7)
Item8 = Item(name="Wooden Wrist Rest", category=4, price=36.99, description="Material: Genuine Black Walnut Wood",
